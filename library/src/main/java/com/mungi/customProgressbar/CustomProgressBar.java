package com.mungi.customProgressbar;
...
import static com.mungi.customProgressbar.CustomProgressBar.ProgressTextVisibility.Invisible;
import static com.mungi.customProgressbar.CustomProgressBar.ProgressTextVisibility.Visible;
...
public class CustomProgressBar extends View {
    ...
    private void calculateDrawRectF() {
        ...
        float temp;
        temp = getProgress() * 100/getMax();

        mCurrentDrawText = String.format("%d", (int)temp);
